...
projections_directory = r"/gpfs/data/kbergen/pvankatw/pvankatw-bfoxkemp/GHub-ISMIP6-Projection-AIS/" if ice_sheet=='AIS' else r"/gpfs/data/kbergen/pvankatw/pvankatw-bfoxkemp/GHub-ISMIP6-Projection-GrIS/"
scalefac_fp = r"/gpfs/data/kbergen/pvankatw/pvankatw-bfoxkemp/af2_el_ismip6_ant_01.nc" if ice_sheet=='AIS' else r"/gpfs/data/kbergen/pvankatw/pvankatw-bfoxkemp/GHub-ISMIP6-Projection-GrIS/af2_ISMIP6_GrIS_05000m.nc"
densities_path = r"/users/pvankatw/research/current/supplemental/AIS_densities.csv" if ice_sheet=='AIS' else r"/users/pvankatw/research/current/supplemental/GIS_densities.csv"
...
processor = ProjectionProcessor(ice_sheet, forcing_directory, projections_directory, scalefac_fp, densities_path)
processor.process()
...
merger = DatasetMerger(ice_sheet, converted_forcing_dir, converted_projection_dir, experiment_file, output_dir)
