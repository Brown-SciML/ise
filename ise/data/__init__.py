...
- ``AnomalyConverter``: convert raw absolute forcing arrays to anomalies using bundled ISMIP6 climatologies; used internally by ``from_raw_values()`` on the input dataclasses.
