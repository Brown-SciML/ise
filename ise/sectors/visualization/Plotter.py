from ise.sectors.utils.data import group_by_run
from ise.sectors.visualization import ensemble, testing
from ise.sectors.utils.data import create_distribution, kl_divergence, js_divergence
import ise
...
class Plotter:
    ...
    def plot_test_series(
        ...
        if not isinstance(model, ise.sectors.models.timeseries.TimeSeriesEmulator):
