from ise.sectors.data.EmulatorData import EmulatorData
from ise.sectors.models.training.Trainer import Trainer
from ise.sectors.models.timeseries import TimeSeriesEmulator
from ise.sectors.models.traditional.ExploratoryModel import ExploratoryModel
from ise.sectors.utils.utils import _structure_emulatordata_args, _structure_architecture_args
        ...
        for num_rnn_layers in rnn_layers_array:
            for num_rnn_hidden in hidden_nodes_array:
                ...
                trainer.train(
                    ...
                    verbose=verbose,
                    sequence_length=5,
                    tensorboard_comment=f" full -- {current_time}, num_rnn={num_rnn_layers}, num_hidden={num_rnn_hidden}, dropout_prob={dropout_prob}, batch_size={batch_size}",
                )
